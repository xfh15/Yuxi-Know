  ...
  <a-card title="ユーザーアクティブ分析" :loading="loading" class="dashboard-card">
    ...
    <div class="compact-chart-container">
      <div class="chart-header">
        <span class="chart-title">アクティブ推移</span>
        <span class="chart-subtitle">直近7日</span>
      </div>
